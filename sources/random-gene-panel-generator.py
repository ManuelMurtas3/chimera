...
print("Generating random gene panel...")

homo_sapiens_gtf_path = "../resources/homo-sapiens-gtf/Homo_sapiens.GRCh38.107.gtf" #gene file name
gene_panel_dimension = 200 #number of genes to randomly select

gene_dictionary = GtfDictionary.gtf_to_dictionary(homo_sapiens_gtf_path, "gene_id")

#prints a list of random genes
#TODO: change random sample to randomizing a number between the number of current keys, creating a new dictionary with the random
...
print("Random gene panel created")